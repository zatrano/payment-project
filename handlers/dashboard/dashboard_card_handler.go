...
// Kart detayını gösterir
func (h *DashboardCardHandler) ShowCard(c *fiber.Ctx) error {
	...
	return renderer.Render(c, "dashboard/cards/show", "layouts/card", fiber.Map{
		"Title": "Kart Detayı",
		"Card":  card,
	})
}
...
func (h *DashboardCardHandler) UpdateCard(c *fiber.Ctx) error {
	...
	newFileName, _ := filemanager.UploadFile(c, "photo", "cards")
